  ...
  return (
    <>
      ...
      <div className=" w-[95%] md:w-[65%] mx-auto md:py-20">
        ...
        >
          Embracing constraints, I've given my best. This is all I can do, a
          testament to determination in the face of challenges.
        </motion.div>
          ...
          {portfolioData?.map((portfolio) => {
            return (
              <motion.div
                ...
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ type: "spring", bounce: 0.6, delay: 0.2 }}
                className=" w-full md:basis-1/2 md:px-2 "
              >
        ...
        >
          If you want to explored my other projects{" "}
          <a href="https://github.com/aungpaingsoe-dev" target="_blank">
            <span className=" flex gap-1 md:px-2 items-center cursor-pointer text-secondary ">
              <FaGithub className=" text-xl " />
              Here my github profile{" "}
            </span>
          </a>
        </motion.div>
      </div>
